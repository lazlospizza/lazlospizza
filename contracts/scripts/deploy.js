...
async function main() {
  ...
  await rendering.setIngredientsIPFSHash(
    'QmRpABeFSqXkpCSxUugwKrKhTrVrJQ2i3yYu7an1fgWYaa',
  );
  ...
  await rendering.setIngredientsDescription(
    "The finest pixelated produce on the blockchain. Combine your faves to bake a pizza in Lazlo's Pizza Cave at lazlospizza.com.",
  );
  await rendering.setPizzaDescription(
    "Pixelated pizzas win prizes in Lazlo's Pizza Cave. Visit lazlospizza.com to bake your own.",
  );
