...
describe("LazlosPizzaShop", function () {
    ...
    it("rendering should work", async function () {
        ...
        expect(metadata1).to.equal('data:application/json;base64,eyJuYW1lIjoiR2x1dGVuIEZyZWUgQmFzZSIsImRlc2NyaXB0aW9uIjoiYmxhaCBibGFoIGJsYWggc29tZXRoaW5nIGFib3V0IHBpenphIiwiaW1hZ2UiOiJodHRwczovL2dhdGV3YXkucGluYXRhLmNsb3VkL2lwZnMvRkFLRV9JUEZTX0hBU0gvMS5wbmcifQ==');
        expect(metadata10).to.equal('data:application/json;base64,eyJuYW1lIjoiQW5jaG92aWVzIiwiZGVzY3JpcHRpb24iOiJibGFoIGJsYWggYmxhaCBzb21ldGhpbmcgYWJvdXQgcGl6emEiLCJpbWFnZSI6Imh0dHBzOi8vZ2F0ZXdheS5waW5hdGEuY2xvdWQvaXBmcy9GQUtFX0lQRlNfSEFTSC8xMC5wbmcifQ==');
        expect(metadata21).to.equal('data:application/json;base64,eyJuYW1lIjoiSmFsYXBlbm9zIiwiZGVzY3JpcHRpb24iOiJibGFoIGJsYWggYmxhaCBzb21ldGhpbmcgYWJvdXQgcGl6emEiLCJpbWFnZSI6Imh0dHBzOi8vZ2F0ZXdheS5waW5hdGEuY2xvdWQvaXBmcy9GQUtFX0lQRlNfSEFTSC8yMS5wbmcifQ==');
    
        const metadataPizza1 = await pizzas.tokenURI(1);
        expect(metadataPizza1).to.equal('data:application/json;base64,');
    });
});
