...
all_ingredients = [
    ...
    { 'name': 'Cheddar Cheese',	'ingredientType': 2, 'id': 6 },
    { 'name': 'Goat Cheese',	'ingredientType': 2, 'id': 7 },
    { 'name': 'Mozzarella',	'ingredientType': 2, 'id': 8 },
    { 'name': 'Anchovies',	'ingredientType': 3, 'id': 9 },
    { 'name': 'Beef',	'ingredientType': 3, 'id': 10 },
    { 'name': 'Chicken',	'ingredientType': 3, 'id': 11 },
    { 'name': 'Chorizo',	'ingredientType': 3, 'id': 12 },
    { 'name': 'Ham',	'ingredientType': 3, 'id': 13 },
    { 'name': 'Pepperonis',	'ingredientType': 3, 'id': 14 },
    { 'name': 'Salami',	'ingredientType': 3, 'id': 15 },
    { 'name': 'Tuna',	'ingredientType': 3, 'id': 16 },
    { 'name': 'Corn',	'ingredientType': 4, 'id': 17 },
    { 'name': 'Chillies',	'ingredientType': 4, 'id': 18 },
    { 'name': 'Green Peppers',	'ingredientType': 4, 'id': 19 },
    { 'name': 'Jalapenos',	'ingredientType': 4, 'id': 20 },
    { 'name': 'Mushroom',	'ingredientType': 4, 'id': 21 },
    { 'name': 'Onion',	'ingredientType': 4, 'id': 22 },
    { 'name': 'Pineapple',	'ingredientType': 4, 'id': 23 },
    { 'name': 'Red Pepper',	'ingredientType': 4, 'id': 24 }
]
